...
const CACHE_NAME = "Space-ships-cache";
const OFFLINE_URL = "Space-ships.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Space-ships.html","Space-ships.js","Space-ships.wasm","Space-ships.pck","Space-ships.offline.html","Space-ships.icon.png","Space-ships.apple-touch-icon.png"];
